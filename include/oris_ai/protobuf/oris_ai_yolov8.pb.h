...
// source: oris_ai_yolov8.proto

#ifndef GOOGLE_PROTOBUF_INCLUDED_oris_5fai_5fyolov8_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_oris_5fai_5fyolov8_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_oris_5fai_5fyolov8_2eproto
...
struct TableStruct_oris_5fai_5fyolov8_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_oris_5fai_5fyolov8_2eproto;
namespace oris_ai {
...
constexpr ActivationType ActivationType_MAX = SiLU;
...
class TorchConv2d PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_oris_5fai_5fyolov8_2eproto);
    return ::descriptor_table_oris_5fai_5fyolov8_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_oris_5fai_5fyolov8_2eproto;
};
// -------------------------------------------------------------------
...
class TorchLayer PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    kNameFieldNumber = 1,
    kPrevLayerFieldNumber = 3,
    kNextLayerFieldNumber = 4,
    kExecutionOrderFieldNumber = 2,
    kConv2DFieldNumber = 6,
    kBatchnorm2DFieldNumber = 7,
    kActivationFieldNumber = 8,
    kMaxpool2DFieldNumber = 9,
    kConcatFieldNumber = 10,
    kUpsampleFieldNumber = 11,
  };
  // string name = 1;
  void clear_name();
  ...
  // string prev_layer = 3;
  void clear_prev_layer();
  const std::string& prev_layer() const;
  void set_prev_layer(const std::string& value);
  void set_prev_layer(std::string&& value);
  void set_prev_layer(const char* value);
  void set_prev_layer(const char* value, size_t size);
  std::string* mutable_prev_layer();
  std::string* release_prev_layer();
  void set_allocated_prev_layer(std::string* prev_layer);
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_prev_layer();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_prev_layer(
      std::string* prev_layer);
  private:
  const std::string& _internal_prev_layer() const;
  void _internal_set_prev_layer(const std::string& value);
  std::string* _internal_mutable_prev_layer();
  public:

  // string next_layer = 4;
  void clear_next_layer();
  const std::string& next_layer() const;
  void set_next_layer(const std::string& value);
  void set_next_layer(std::string&& value);
  void set_next_layer(const char* value);
  void set_next_layer(const char* value, size_t size);
  std::string* mutable_next_layer();
  std::string* release_next_layer();
  void set_allocated_next_layer(std::string* next_layer);
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_next_layer();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_next_layer(
      std::string* next_layer);
  private:
  const std::string& _internal_next_layer() const;
  void _internal_set_next_layer(const std::string& value);
  std::string* _internal_mutable_next_layer();
  public:

  // int32 execution_order = 2;
  void clear_execution_order();
  ::PROTOBUF_NAMESPACE_ID::int32 execution_order() const;
  void set_execution_order(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_execution_order() const;
  void _internal_set_execution_order(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:

  // .oris_ai.TorchConv2d conv2d = 6;
  ...
  // .oris_ai.TorchBatchNorm2d batchnorm2d = 7;
  ...
  // .oris_ai.TorchActivation activation = 8;
  ...
  // .oris_ai.TorchMaxPool2d maxpool2d = 9;
  ...
  // .oris_ai.TorchUpsample upsample = 11;
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr prev_layer_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr next_layer_;
  ::PROTOBUF_NAMESPACE_ID::int32 execution_order_;
...
// int32 execution_order = 2;
inline void TorchLayer::clear_execution_order() {
  execution_order_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 TorchLayer::_internal_execution_order() const {
  return execution_order_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 TorchLayer::execution_order() const {
  // @@protoc_insertion_point(field_get:oris_ai.TorchLayer.execution_order)
  return _internal_execution_order();
}
inline void TorchLayer::_internal_set_execution_order(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  execution_order_ = value;
}
inline void TorchLayer::set_execution_order(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_execution_order(value);
  // @@protoc_insertion_point(field_set:oris_ai.TorchLayer.execution_order)
}

// string prev_layer = 3;
inline void TorchLayer::clear_prev_layer() {
  prev_layer_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& TorchLayer::prev_layer() const {
  // @@protoc_insertion_point(field_get:oris_ai.TorchLayer.prev_layer)
  return _internal_prev_layer();
}
inline void TorchLayer::set_prev_layer(const std::string& value) {
  _internal_set_prev_layer(value);
  // @@protoc_insertion_point(field_set:oris_ai.TorchLayer.prev_layer)
}
inline std::string* TorchLayer::mutable_prev_layer() {
  // @@protoc_insertion_point(field_mutable:oris_ai.TorchLayer.prev_layer)
  return _internal_mutable_prev_layer();
}
inline const std::string& TorchLayer::_internal_prev_layer() const {
  return prev_layer_.Get();
}
inline void TorchLayer::_internal_set_prev_layer(const std::string& value) {
  
  prev_layer_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void TorchLayer::set_prev_layer(std::string&& value) {
  
  prev_layer_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:oris_ai.TorchLayer.prev_layer)
}
inline void TorchLayer::set_prev_layer(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  prev_layer_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:oris_ai.TorchLayer.prev_layer)
}
inline void TorchLayer::set_prev_layer(const char* value,
    size_t size) {
  
  prev_layer_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:oris_ai.TorchLayer.prev_layer)
}
inline std::string* TorchLayer::_internal_mutable_prev_layer() {
  
  return prev_layer_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* TorchLayer::release_prev_layer() {
  // @@protoc_insertion_point(field_release:oris_ai.TorchLayer.prev_layer)
  return prev_layer_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TorchLayer::set_allocated_prev_layer(std::string* prev_layer) {
  if (prev_layer != nullptr) {
    
  } else {
    
  }
  prev_layer_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), prev_layer,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:oris_ai.TorchLayer.prev_layer)
}
inline std::string* TorchLayer::unsafe_arena_release_prev_layer() {
  // @@protoc_insertion_point(field_unsafe_arena_release:oris_ai.TorchLayer.prev_layer)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return prev_layer_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void TorchLayer::unsafe_arena_set_allocated_prev_layer(
    std::string* prev_layer) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (prev_layer != nullptr) {
  ...
  prev_layer_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      prev_layer, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:oris_ai.TorchLayer.prev_layer)
}

// string next_layer = 4;
inline void TorchLayer::clear_next_layer() {
  next_layer_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& TorchLayer::next_layer() const {
  // @@protoc_insertion_point(field_get:oris_ai.TorchLayer.next_layer)
  return _internal_next_layer();
}
inline void TorchLayer::set_next_layer(const std::string& value) {
  _internal_set_next_layer(value);
  // @@protoc_insertion_point(field_set:oris_ai.TorchLayer.next_layer)
}
inline std::string* TorchLayer::mutable_next_layer() {
  // @@protoc_insertion_point(field_mutable:oris_ai.TorchLayer.next_layer)
  return _internal_mutable_next_layer();
}
inline const std::string& TorchLayer::_internal_next_layer() const {
  return next_layer_.Get();
}
inline void TorchLayer::_internal_set_next_layer(const std::string& value) {
  
  next_layer_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void TorchLayer::set_next_layer(std::string&& value) {
  
  next_layer_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:oris_ai.TorchLayer.next_layer)
}
inline void TorchLayer::set_next_layer(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  next_layer_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:oris_ai.TorchLayer.next_layer)
}
inline void TorchLayer::set_next_layer(const char* value,
    size_t size) {
  
  next_layer_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:oris_ai.TorchLayer.next_layer)
}
inline std::string* TorchLayer::_internal_mutable_next_layer() {
  
  return next_layer_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* TorchLayer::release_next_layer() {
  // @@protoc_insertion_point(field_release:oris_ai.TorchLayer.next_layer)
  return next_layer_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TorchLayer::set_allocated_next_layer(std::string* next_layer) {
  if (next_layer != nullptr) {
    
  } else {
    
  }
  next_layer_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), next_layer,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:oris_ai.TorchLayer.next_layer)
}
inline std::string* TorchLayer::unsafe_arena_release_next_layer() {
  // @@protoc_insertion_point(field_unsafe_arena_release:oris_ai.TorchLayer.next_layer)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return next_layer_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void TorchLayer::unsafe_arena_set_allocated_next_layer(
    std::string* next_layer) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (next_layer != nullptr) {
  ...
  next_layer_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      next_layer, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:oris_ai.TorchLayer.next_layer)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_oris_5fai_5fyolov8_2eproto
